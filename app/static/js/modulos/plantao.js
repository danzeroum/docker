/* Módulo `plantao` (registro do doc 10 §1).
 *
 * Corpo reaproveitado de `screens/plantao.js` — o doc 09 §A já previa isso como 🔧:
...
export default {
  ...
  escopos: ['host'],
  span: 12,
  render: (escopo, dados, corpo) => renderPlantao(corpo, escopo, dados),
};
